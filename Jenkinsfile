...
steps
{
nexusArtifactUploader artifacts: [[artifactId: 'java1', classifier: '', file: 'target/java.war', type: 'war']], credentialsId: 'nexus', groupId: 'com.java', nexusUrl: '18.117.179.51:5051/', nexusVersion: 'nexus3', protocol: 'http', repository: 'JavaMavenRepo', version: '1.0.0'
}
}
